...
async function main(){
  ...
  app.post('/', async (req, res)=>{
    if(req.body.key){
      ...
      req.send(pages.home+`<script>window.alert('Account added to queue. (Click the ok button, and your unique key will be shown to you three times)')
      window.alert("${newkey}")
      window.alert("${newkey}")
      window.alert("${newkey}")
      </script>`)
